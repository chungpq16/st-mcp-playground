...
Streamlit application for interacting with LangChain MCP (Model Context Protocol) servers.
...
from src.ui_components import render_sidebar, render_mcp_configuration_tab
...
def main():
    ...
    # Create main tabs
    tab_chat, tab_mcp, tab_test, tab_memory, tab_config = st.tabs([
        "💬 Chat", 
        "🔗 MCP Servers",
        "🔧 Test Tools", 
        "🧠 Memory", 
